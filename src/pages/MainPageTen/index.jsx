...
const MainPageTenPage = () => {
  const navigate = useNavigate();

  return (
    <>
      <div className="bg-gray-100_03 flex flex-col font-abyssinicasil items-start justify-end mx-auto pt-[29px] sm:px-5 px-[29px] w-full">
        <div className="flex flex-col gap-14 justify-end mt-[17px] md:px-5 w-[95%] md:w-full">
          <div className="flex md:flex-col flex-row md:gap-5 items-center justify-end md:ml-[0] ml-[65px] w-[96%] md:w-full">
            <Img
              className="h-[149px] sm:h-auto object-cover w-[11%] md:w-full"
              src="images/img_screenshot20231104_149x157.png"
              alt="screenshot20231"
            />
            <div className="flex flex-row gap-1.5 items-start justify-center ml-1.5 md:ml-[0] w-[17%] md:w-full">
              <Text
          ...
          <div className="flex md:flex-col flex-row md:gap-[53px] items-center justify-between mr-[19px] w-[99%] md:w-full">
            <div className="flex flex-col items-center justify-start w-[41%] md:w-full">
              <div className="flex md:flex-col flex-row gap-1.5 items-center justify-between w-full">
                ...
                />
                <div className="md:h-[73px] h-[82px] relative w-[85%] md:w-full">
              ...
              <Img
                className="h-[768px] md:h-auto object-cover rounded-[42px] w-[88%]"
            ...
            <div className="bg-gradient1  flex flex-col items-start justify-end md:mt-0 mt-5 outline outline-[3px] outline-blue-A200 p-[18px] rounded-[35px] shadow-bs10 w-[56%] md:w-full">
              <div className="flex flex-col md:gap-10 gap-[89px] justify-start mb-[7px] mt-[30px] w-[95%] md:w-full">
                <div className="flex flex-row gap-[9px] items-center justify-start md:ml-[0] ml-[31px] w-[47%] md:w-full">
                  <Text
                ...
                >
                  Peaches are a delicious and nutritious fruit that offer a
                  variety of health benefits. They are rich in vitamins,
                  minerals, and antioxidants that can help protect your body
                  from aging and disease. Peaches are also high in fiber, which
                  can help improve digestion and reduce the risk
                  of constipation.
                </Text>
              </div>
            </div>
...
export default MainPageTenPage;
