...
const MainPageOnePage = () => {
  ...
  return (
    <>
      <div className="bg-gray-100_03 flex flex-col font-abyssinicasil items-start justify-end mx-auto pt-[22px] sm:px-5 px-[22px] w-full">
        <div className="flex flex-col md:gap-10 gap-[61px] justify-end mt-[19px] md:px-5 w-[95%] md:w-full">
          <div className="flex md:flex-col flex-row md:gap-5 items-start justify-end md:ml-[0] ml-[65px] w-[96%] md:w-full">
            <Img
              ...
              alt="screenshot20231"
            />
            <div className="flex flex-row gap-1.5 items-start justify-center md:ml-[0] ml-[13px] md:mt-0 mt-[50px] w-[17%] md:w-full">
              <Text
          ...
          <div className="flex md:flex-col flex-row gap-8 items-start justify-between mr-[19px] w-[99%] md:w-full">
            <div className="flex flex-col gap-7 justify-start w-[43%] md:w-full">
              <div className="flex md:flex-col flex-row gap-[13px] items-center justify-between mr-5 w-[97%] md:w-full">
                <Img
              ...
              <Img
                className="h-[718px] md:h-auto md:ml-[0] ml-[106px] object-cover rounded-[68px] w-[84%]"
                src="images/img_pizza.png"
                alt="pizza"
              />
            </div>
            <div className="bg-gradient1  flex flex-col items-start justify-end md:mt-0 mt-5 outline outline-[3px] outline-blue-A200 p-[18px] rounded-[35px] shadow-bs10 w-[56%] md:w-full">
              <div className="flex flex-col md:gap-10 gap-[90px] justify-start mb-[7px] mt-[29px] w-[95%] md:w-full">
                <div className="flex flex-row gap-4 items-center justify-start md:ml-[0] ml-[31px] w-[34%] md:w-full">
                  <Text
                ...
                >
                  Pizza is a savory dish that originated in Italy. It consists
                  of a flatbread base made of leavened wheat dough, topped with
                  tomato sauce, cheese, and various other ingredients such as
                  vegetables, meat, and herbs. The dish is then baked at a high
...
export default MainPageOnePage;
