...
const MainPageTwoPage = () => {
  const navigate = useNavigate();

  return (
    <>
      <div className="bg-gray-100_03 flex flex-col font-abyssinicasil items-start justify-end mx-auto pt-[15px] px-[15px] w-full">
        <div className="flex flex-col md:gap-10 gap-[62px] justify-end mt-[25px] md:px-5 w-[94%] md:w-full">
          <div className="flex md:flex-col flex-row md:gap-5 items-start justify-end md:ml-[0] ml-[65px] w-[96%] md:w-full">
            <Img
              className="h-[149px] sm:h-auto object-cover w-[11%] md:w-full"
              src="images/img_screenshot20231104_149x157.png"
              alt="screenshot20231"
            />
            <div className="flex flex-row gap-1.5 items-start justify-center ml-2.5 md:ml-[0] md:mt-0 mt-[51px] w-[17%] md:w-full">
              <Text
            ...
            <div className="flex sm:flex-col flex-row gap-[47.59px] items-center justify-start md:ml-[0] ml-[458px] md:mt-0 mt-[52px] w-auto sm:w-full">
            ...
            <Text
              className="bg-gradient  ml-7 md:ml-[0] md:mt-0 mt-[42px] pb-2 pt-4 sm:px-5 px-[35px] rounded-[17px] sm:text-3xl md:text-[32px] text-[34px] text-white-A700"
              size="txtAbyssinicaSILRegular34"
            >
              Log In
            </Text>
          </div>
          <div className="flex md:flex-col flex-row md:gap-[53px] items-center justify-between mr-[19px] w-[99%] md:w-full">
            <div className="flex flex-col gap-[9px] justify-start mb-3.5 w-[41%] md:w-full">
              <div className="flex md:flex-col flex-row gap-2.5 items-center justify-between w-full">
                ...
                />
                <div className="md:h-[73px] h-[82px] relative w-[84%] md:w-full">
              ...
              <Img
                className="h-[768px] md:h-auto md:ml-[0] ml-[65px] object-cover rounded-[68px] w-[87%]"
                src="images/img_cholebhature1_768x555.png"
                alt="cholebhatureOne"
              />
            </div>
            <div className="bg-gradient1  flex flex-col items-start justify-end outline outline-[3px] outline-blue-A200 p-[18px] rounded-[35px] shadow-bs10 w-[56%] md:w-full">
              <div className="flex flex-col md:gap-10 gap-[89px] items-end justify-start mb-[7px] mt-[30px] w-[95%] md:w-full">
                <div className="flex md:flex-col flex-row gap-3 items-center justify-start w-[82%] md:w-full">
                  <Text
                ...
                <div className="flex flex-col items-center justify-start pb-[15px] w-4/5 md:w-full">
                ...
                >
                  Chole bhature is a popular food dish in the northern regions
                  of the Indian subcontinent, particularly in Delhi, India. It
                  is a combination of chana masala (spicy white chickpeas) and
                  bhatura (a deep-fried bread made from maida flour).
                </Text>
              </div>
            </div>
          </div>
...
export default MainPageTwoPage;
