  ...
  return (
    <>
      <div className="bg-gray-100_03 flex flex-col font-abyssinicasil items-start justify-end mx-auto pt-[25px] sm:px-5 px-[25px] w-full">
        <div className="flex flex-col md:gap-10 gap-16 justify-end mt-[21px] md:px-5 w-[94%] md:w-full">
          <div className="flex md:flex-col flex-row md:gap-5 items-center justify-end md:ml-[0] ml-[63px] w-[96%] md:w-full">
            <Img
              className="h-[149px] sm:h-auto object-cover w-[11%] md:w-full"
              src="images/img_screenshot20231104_149x157.png"
              alt="screenshot20231"
            />
            <div className="flex flex-row gap-1.5 items-start justify-center ml-0.5 md:ml-[0] w-[17%] md:w-full">
              <Text
          ...
          <div className="flex md:flex-col flex-row md:gap-5 items-start justify-start mr-[19px] w-[99%] md:w-full">
            ...
            />
            <div className="flex flex-col gap-5 items-center justify-start md:mt-0 mt-1 w-[36%] md:w-full">
              ...
              <Img
                className="h-[768px] md:h-auto object-cover rounded-tl-[78px] rounded-tr-[78px] w-full"
                src="images/img_rectangle3_768x555.png"
                alt="rectangleThree"
              />
            </div>
            <div className="bg-gradient1  flex flex-col items-start justify-end md:ml-[0] ml-[33px] md:mt-0 mt-3 outline outline-[3px] outline-blue-A200 p-[18px] rounded-[35px] shadow-bs10 w-[57%] md:w-full">
              <div className="flex flex-col md:gap-10 gap-[89px] justify-start mb-[7px] mt-[30px] w-[95%] md:w-full">
                <div className="flex flex-row gap-[9px] items-center justify-start md:ml-[0] ml-[31px] w-[43%] md:w-full">
                  <Text
                ...
                <div className="flex flex-col items-center justify-start ml-12 md:ml-[0] pb-[15px] w-4/5 md:w-full">
                ...
                >
                  Burgers are a popular food that can be enjoyed in many
                  different ways. Whether you like them with cheese, bacon, or
                  just plain, burgers are a delicious and satisfying meal that
                  can be enjoyed any time of the day. Not only are burgers
                  tasty, but they also have several health benefits.
                </Text>
              </div>
            </div>
          </div>
...
export default MainPageFivePage;
