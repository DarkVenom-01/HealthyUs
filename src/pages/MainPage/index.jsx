...
const MainPagePage = () => {
  ...
  return (
    <>
      <div className="bg-gray-100_03 flex flex-col font-abyssinicasil items-start justify-end mx-auto pt-[35px] sm:px-5 px-[35px] w-full">
        <div className="flex flex-col gap-[37px] items-center justify-end mt-1.5 md:px-5 w-[95%] md:w-full">
          <div className="flex md:flex-col flex-row md:gap-5 items-start justify-start w-[97%] md:w-full">
            <Img
              ...
              alt="screenshot20231"
            />
            <div className="flex flex-row gap-1.5 items-start justify-center ml-4 md:ml-[0] md:mt-0 mt-[50px] w-[17%] md:w-full">
              <Text
          ...
          <div className="flex md:flex-col flex-row gap-[33px] items-start justify-between w-[99%] md:w-full">
            <div className="flex flex-col gap-5 justify-start mb-[23px] w-[42%] md:w-full">
              <div className="flex md:flex-col flex-row md:gap-5 items-end justify-evenly mr-[19px] w-[97%] md:w-full">
                <Img
                  className="common-pointer h-[115px] sm:h-auto mb-1 object-cover w-[15%] md:w-full"
                  src="images/img_pngclipartcom.png"
                  alt="pngclipartcom"
                  onClick={() => navigate("/landingnew")}
                />
                <div className="md:h-[73px] h-[82px] md:mt-0 mt-9 relative w-[86%] md:w-full">
            ...
            <div className="bg-gradient1  flex flex-col items-start justify-end md:mt-0 mt-11 outline outline-[3px] outline-blue-A200 p-[18px] rounded-[35px] shadow-bs10 w-[57%] md:w-full">
              <div className="flex flex-col md:gap-10 gap-[90px] justify-start mb-[7px] mt-[29px] w-[95%] md:w-full">
                ...
                >
                  Meat is a good source of protein, which is essential for
                  building and repairing muscle, maintaining healthy hair,
                  bones, skin, and nails, and supporting the immune system.Meat
                  is high in vitamins and minerals, including vitamin B12, iron,
                  and zinc, which are important for maintaining good health.
                </Text>
              </div>
            </div>
          </div>
