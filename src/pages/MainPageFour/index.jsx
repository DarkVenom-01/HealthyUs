  ...
  return (
    <>
      <div className="bg-gray-100_03 flex flex-col font-abyssinicasil items-start justify-end mx-auto pt-[25px] sm:px-5 px-[25px] w-full">
        <div className="flex flex-col gap-[58px] justify-end mt-4 md:px-5 w-[94%] md:w-full">
          <div className="flex md:flex-col flex-row md:gap-5 items-start justify-end md:ml-[0] ml-[63px] w-[96%] md:w-full">
            <Img
              className="h-[149px] sm:h-auto object-cover w-[11%] md:w-full"
              src="images/img_screenshot20231104_149x157.png"
              alt="screenshot20231"
            />
            <div className="flex flex-row gap-1.5 items-start justify-center ml-0.5 md:ml-[0] md:mt-0 mt-[50px] w-[17%] md:w-full">
              <Text
          ...
          <div className="flex md:flex-col flex-row md:gap-[52px] items-center justify-between mr-[19px] w-[99%] md:w-full">
            <div className="flex flex-col gap-[7px] items-end justify-start mb-[19px] w-[41%] md:w-full">
              <div className="flex md:flex-col flex-row md:gap-5 items-center justify-evenly w-full">
                <Img
                  className="common-pointer md:flex-1 h-[115px] sm:h-auto object-cover w-[15%] md:w-full"
                  src="images/img_pngclipartcom.png"
                  alt="pngclipartcom"
                  onClick={() => navigate("/landingnew")}
                />
                <div className="md:h-[73px] h-[82px] relative w-[86%] md:w-full">
              ...
              <Img
                className="h-[768px] md:h-auto object-cover rounded-[42px] w-[89%]"
                src="images/img_rectangle1_370x309.png"
                alt="rectangleOne"
              />
            </div>
            <div className="bg-gradient1  flex flex-col items-center justify-end outline outline-[3px] outline-blue-A200 p-[18px] rounded-[35px] shadow-bs10 w-[57%] md:w-full">
              <div className="flex flex-col md:gap-10 gap-[89px] justify-start mb-[7px] mt-[30px] w-[98%] md:w-full">
                <div className="flex md:flex-col flex-row md:gap-5 items-center justify-evenly md:ml-[0] ml-[31px] w-[97%] md:w-full">
                  <Text
                ...
                <div className="flex flex-col items-center justify-start ml-12 md:ml-[0] pb-3.5 w-[77%] md:w-full">
                ...
                <Text
                  className="mr-[29px] md:text-3xl sm:text-[28px] text-[32px] text-black-900 w-[97%] sm:w-full"
                  size="txtAbyssinicaSILRegular32Black900"
                >
                  Cheese-filled pizza is a delicious and indulgent treat that
                  can be enjoyed on any occasion. Not only is it a tasty meal,
                  but it also has several health benefits. Cheese is a good
                  source of protein, calcium, and vitamin D, which are essential
                  for building and maintaining strong bones and muscles.
                </Text>
              </div>
            </div>
          </div>
...
export default MainPageFourPage;
